...
export default function Home() {
  ...
  return (
    <div className="terminal-theme min-h-screen bg-black text-gray-400 selection:bg-green-900 selection:text-white">
      <Scanline />
      <TerminalNav />
      ...
      <main>
            ...
            <TerminalWindow>
              <div className="space-y-2">
                ...
                <p className="text-sm md:text-base text-gray-500 max-w-2xl leading-relaxed">
                  ...
                  All actions are logged to kernel-01.local.
                </p>
              </div>
        ...
        <section
          id="modules"
          className="max-w-6xl mx-auto py-20 px-6 space-y-32"
        >
