...
export class StatusController {
    ...
    async createStatus(
        ...
        return ApiResponse.success(createdStatus, 'Status created successfully', HttpStatus.CREATED);
    }
    ...
    async getAllStatuses(
        ...
        this.loggerService.log(`Get All Statuses Called By ${callerId}`, this.context);
        const statuses = await this.statusService.getAllStatuses(callerId, workspaceId, projectId);
    ...
    @SwaggerApiResponse({
        status: HttpStatus.CONFLICT,
        description: 'A status with the updated name already exists in this project.',
    })
    @SwaggerApiResponse({
        status: HttpStatus.NOT_FOUND,
    ...
    async reorderStatuses(
        ...
        this.loggerService.log(`Reorder Statuses Called By ${callerId}`, this.context);
    ...
    async deleteStatus(
        ...
        await this.statusService.deleteStatus(callerId, workspaceId, projectId, statusId);
