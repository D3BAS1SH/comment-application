...
export class StatusService {
    ...
    private async getCallerRole(workspaceId: string, callerId: string): Promise<string> {
    ...
    private async verifyProject(workspaceId: string, projectId: string): Promise<void> {
    ...
    private async verifyStatus(projectId: string, statusId: string): Promise<void> {
    ...
    async createStatus(
        ...
        try {
            ...
            if (role !== 'ADMIN' && role !== 'OWNER') {
                throw new ForbiddenException('You do not have permission to create a status');
            }
    ...
    async updateStatus(
        ...
        try {
            ...
            if (role !== 'ADMIN' && role !== 'OWNER') {
                throw new ForbiddenException('You do not have permission to update a status');
            }
    ...
    async deleteStatus(
        ...
        try {
            ...
            if (role !== 'ADMIN' && role !== 'OWNER') {
                throw new ForbiddenException('You do not have permission to delete a status');
            }
