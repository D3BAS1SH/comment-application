...
export class CommentController {
    ...
    async createComment(
        ...
        this.loggerService.log(`Create Comment Called By ${callerId}`, this.context);
        const comment = await this.commentService.createComment(callerId, issueId, createCommentObject);
    ...
    async updateComment(
        ...
        this.loggerService.log(`Update Comment Called By ${callerId}`, this.context);
        const comment = await this.commentService.updateComment(callerId, issueId, commentId, updateCommentObject);
    ...
    async deleteComment(
        ...
        this.loggerService.log(`Delete Comment Called By ${callerId}`, this.context);
