...
export class IssueController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new issue within the specified project. Requires workspace membership and appropriate permissions (non-VIEWER).',
  })
  @ApiParam({
    name: 'projectId',
  ...
  @SwaggerApiResponse({
    ...
    description: 'Project or related entity not found.',
  })
  @SwaggerApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'Caller is not a member or lacks necessary role.',
  })
  @SwaggerApiResponse({
  ...
  async createIssue(
    ...
    const result = await this.issueService.createIssue(
      callerId,
      projectId,
      createIssueObject
    );
  ...
  @ApiOperation({
    ...
    description:
      'Returns a list of issues for the specified project matching the provided filters. Available to all workspace members.',
  })
  @ApiParam({
    name: 'projectId',
    description: 'The unique identifier of the project.',
  ...
  async getAllIssues(
    ...
    const result = await this.issueService.getIssues(callerId, projectId, {
      sprintId,
      epicId,
      assigneeId,
      statusId,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves the full details of a specific issue including its labels, subtasks, and other relations.',
  })
  @ApiParam({
    name: 'projectId',
    description: 'The unique identifier of the project.',
  ...
  async getIssue(
    ...
    this.loggerService.log(
      `Get Specific Issue Called By ${callerId}`,
      this.context
    );
    const result = await this.issueService.getIssue(
      callerId,
      projectId,
      issueId
    );
  ...
  @ApiOperation({
    ...
    description:
      'Updates specific fields of an issue and logs the changes as activities. Requires write permissions (non-VIEWER).',
  })
  @ApiParam({
    name: 'projectId',
    description: 'The unique identifier of the project.',
  ...
  @SwaggerApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Issue or related entity not found.',
  })
  @SwaggerApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'Caller is not a member or lacks necessary role.',
  ...
  @ApiOperation({
    ...
    description:
      'Permanently deletes an issue and its associated activities. Subtasks will be unlinked or deleted based on relations.',
  })
  @ApiParam({
    name: 'projectId',
    description: 'The unique identifier of the project.',
  ...
  @ApiOperation({
    ...
    description:
      'Updates the position of an issue within its current status column or moves it to a new status column and reorders.',
  })
  @ApiParam({
    name: 'projectId',
    description: 'The unique identifier of the project.',
  ...
  @SwaggerApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Issue or Status not found.',
  })
  @SwaggerApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'Caller is not a member or lacks necessary role.',
  ...
  async reorderIssues(
    ...
    const result = await this.issueService.reorderIssue(
      callerId,
      projectId,
      issueId,
      reorderIssuesObject
  ...
  @ApiOperation({
    ...
    description:
      'Moves an issue to a specific sprint or to the backlog if sprintId is explicitly passed as null.',
  })
  @ApiParam({
    name: 'projectId',
    description: 'The unique identifier of the project.',
  ...
  async moveIssueToSprint(
    ...
    this.loggerService.log(
      `Move to Sprint Issue Called By ${callerId}`,
      this.context
    );
    const result = await this.issueService.moveToSprint(
      callerId,
      projectId,
      issueId,
      moveIssueSprintObject
    );
    return ApiResponse.success(
      result,
  ...
  async attachLabelToIssue(
    ...
    this.loggerService.log(
      `Add Label to Issue Called By ${callerId}`,
      this.context
    );
    const result = await this.issueService.addLabel(
      callerId,
      projectId,
      issueId,
      labelId
    ...
    return ApiResponse.success(
      result,
      'Label attached to issue successfully',
      HttpStatus.OK
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Detaches a previously attached label from the specified issue.',
  })
  @ApiParam({
    name: 'projectId',
    description: 'The unique identifier of the project.',
  ...
  async detachLabelFromIssue(
    ...
    this.loggerService.log(
      `Remove Label from Issue Called By ${callerId}`,
      this.context
    );
    const result = await this.issueService.removeLabel(
      callerId,
      projectId,
      issueId,
      labelId
    ...
    return ApiResponse.success(
      result,
      'Label detached from issue successfully',
      HttpStatus.OK
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a history of activities/changes associated with the specified issue.',
  })
  @ApiParam({
    name: 'projectId',
    description: 'The unique identifier of the project.',
  ...
  async allActivityOfIssue(
    ...
    this.loggerService.log(
      `List all Issue activities Called By ${callerId}`,
      this.context
    );
    const result = await this.issueService.getActivities(
      callerId,
      projectId,
      issueId
    );
  ...
  async allSubTasks(
    ...
    this.loggerService.log(
      `List all subtask Issue Called By ${callerId}`,
      this.context
    );
    const result = await this.issueService.getSubtasks(
      callerId,
      projectId,
      issueId
    );
    return ApiResponse.success(
      result,
      'Issue subtasks retrieved successfully',
      HttpStatus.OK
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all comments associated with the specified issue, including author details.',
  })
  @ApiParam({
    name: 'projectId',
    description: 'The unique identifier of the project.',
  ...
  async getIssueComments(
    ...
    this.loggerService.log(
      `List all comments of Issue Called By ${callerId}`,
      this.context
    );
    const result = await this.issueService.getIssueComments(
      callerId,
      projectId,
      issueId
    );
